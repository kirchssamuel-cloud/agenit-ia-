...
export const config = {
  matcher: [
     ...
     */
    "/((?!_next/static|_next/image|favicon.ico|sitemap.xml|robots.txt|api/health|api/test|api/portal|api/webhooks|api/setup-mvp|api/agent-test|api/agent-gemini-test|api/cron|api/admin|api/oauth/google/start-public|api/oauth/google/callback|api/integrations|api/agent-web|onboarding|client-area|connect|configure|whatsapp).*)",
  ],
};
