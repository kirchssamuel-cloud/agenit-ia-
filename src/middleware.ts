...
export const config = {
  matcher: [
     ...
     */
    "/((?!_next/static|_next/image|favicon.ico|sitemap.xml|robots.txt|api/health|api/test|api/portal|api/webhooks|api/setup-mvp|api/agent-test|api/agent-gemini-test|api/cron|whatsapp).*)",
  ],
};
